...
public class SeasonsController {
    ...
    @GetMapping("")
    public ResponseEntity<?> findShowSeasons(@PathVariable("showId") long showId) {
        Optional<Show> show = showsService.findById(showId);
        if (show.isEmpty())
    ...
    @PostMapping("")
    public ResponseEntity<?> addShowSeason(@PathVariable("showId") long showId,
                                           @RequestBody(required = false) Season season) {
        Show show;
        try {
