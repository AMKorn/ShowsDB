...
class ShowTest {
    @Test
    void testCreate() {
        Show show = new Show(0L, "What We Do in the Shadows", "United States", null, null);
    ...
    @Test
    void testEqual() {
        Show show1 = new Show(0L, "What We Do in the Shadows", "United States", null, null);
        Show show2 = new Show(0L, "What We Do in the Shadows", "United States", null, null);
        Show show3 = new Show(1L, "The Good Place", "United States", null, null);
